...
CREATE TABLE "cart_items" (
	...
	CONSTRAINT "cart_items_cart_menu_item_unique" UNIQUE("cart_id","menu_item_id")
);
--> statement-breakpoint
...
CREATE INDEX "carts_restaurant_id_idx" ON "carts" USING btree ("restaurant_id");--> statement-breakpoint
